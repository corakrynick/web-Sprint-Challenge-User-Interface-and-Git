...
Semantic HTML is the use of HTML to reinforce the meaning of content on a web page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Diplay: block; takes up the full width available, with a new line before and after whereas display: inline; only takes up as much width as it needs, and does not force new lines.
...
It allows multiple people to work on code in a seperate branch and save changes once finished to the main branch.
